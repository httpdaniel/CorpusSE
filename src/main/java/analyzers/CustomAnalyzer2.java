...
//
//    public CustomAnalyzer2(CharArraySet stopwords) {
//        super(stopwords);
//    }
//
...
//
//
//    private static SynonymMap buildSynonym() throws IOException,
//            ParseException
//    {
//        SynonymMap.Builder parser = null;
//
//        File file = new File("corpus/prolog/wn_s.pl");
//        InputStream stream = new FileInputStream(file);
//        Reader rules = new InputStreamReader(stream);
//
...
public class CustomAnalyzer2 extends Analyzer {
    ...
    protected TokenStreamComponents createComponents(String fieldName)  {
        ...
        BufferedReader kr = null;
        String line = "";

        try {
            kr = new BufferedReader(new FileReader("corpus/keywords"));
            line = kr.readLine();
        } catch (Exception e) {
            e.printStackTrace();
        }

        String[] allKeywords = line.split(",");
        CharArraySet keywords =  new CharArraySet(Arrays.asList(allKeywords), true);
        ...
        // result = new SetKeywordMarkerFilter((TokenStream)result, new CharArraySet(Arrays.asList(allKeywords), true));
...
//            mySynonymMap = buildSynonym();
//        }catch (Exception e){e.printStackTrace();}
//        result = new SynonymGraphFilter(result, mySynonymMap, true);
...
//        CharArraySet stopwords = new CharArraySet(Arrays.asList(stopwordsList), true);
        ...
        FileReader doctoread = new FileReader("corpus/prolog/wn_s.pl");
        File file = new File("corpus/prolog/wn_s.pl");
        InputStream stream = new FileInputStream(file);
        Reader rules = new InputStreamReader(stream);
